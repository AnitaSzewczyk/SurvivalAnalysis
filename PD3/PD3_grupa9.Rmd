...
Na poziomie istotności $\alpha$ = 0.05, zmienna `LogSCC` jest statystycznie istotna w modelu. Wartość krytyczna przy zmiennej `frailty(Hazard)`, która jest mniejsza od zakładanego poziomu istotności $0.05$ oznacza, że mamy statystycznie istotne podstawy do stwierdzenia, że istenieje efekt stada. Przy wzroście logarytmu wartości SCC o jeden, hazard do brakowania jałówki wzrasta 1.072 raza. Wymienione efekty odnoszą się tylko do krów z tego samego stada.
